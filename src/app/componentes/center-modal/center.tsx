...
export default function Center() {
  ...
  const handleSubmit = async () => {
    ...
    // Garantindo que botResponse seja sempre uma string
    const botResponse = (await generateUserResponse(resultado, mockUserData.perfilPreferido)) || "Desculpe, não consegui entender a sua solicitação.";
  ...
  return (
    <div className={styles.center}>
      <div className={styles.Tittle}>
        <h1 className={styles.tittle}>Olá! Eu sou o Omni Bot.<br />Como posso te ajudar hoje?</h1>
      </div>
